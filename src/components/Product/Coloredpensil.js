...
import data from "./coloredpencil.json"
import img1 from "./coloredpensil/coloredpensil (1).jpg"
import img2 from "./coloredpensil/coloredpensil (2).jpg"
import img3 from "./coloredpensil/coloredpensil (3).jpg"
import img4 from "./coloredpensil/coloredpensil (4).jpg"
import img5 from "./coloredpensil/coloredpensil (5).jpg"
import img6 from "./coloredpensil/coloredpensil (6).jpg"
import img7 from "./coloredpensil/coloredpensil (7).jpg"
import img8 from "./coloredpensil/coloredpensil (8).jpg"
...
const faq = [
  {
      "id": 1 ,
      "question" : "1. What is starting price of a Coloured Pencil Portrait?",
      "answer" : "Coloured Pencil Portraits start from $110. The price will change based on the subjects and size."
  },
  {
      "id": 2 ,
      "question" : "3. Can I frame my Colored Pencil Sketch?",
      "answer" : "Yes! We provide framing service to all our Colored Pencil Drawings.Continue placing the order, and after you are done, you can add the frame as an add-on from your orders dashboard."
  },
  {
      "id": 3 ,
      "question" : "4. I want to merge people from different photos into one colored pencil portrait. Is it possible?",
      "answer" : "Yes, but we will recommend you to buy an oil painting if you are merging characters as an oil painting is well-blended and realistic."
  }
];
    return (
        <div>
        ...
        <Searchbar/>
            <h1 className='font-bold'>Colored Pensil Drawing</h1>
        </div>
