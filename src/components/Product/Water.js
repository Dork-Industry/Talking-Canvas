...
import data from "./Watercolor.json";
import img1 from "./water/water (1).jpg"
import img2 from "./water/water (2).jpg"
import img3 from "./water/water (3).jpg"
import img4 from "./water/water (4).jpg"
import img5 from "./water/water (5).jpg"
import img6 from "./water/water (6).jpg"
import img7 from "./water/water (7).jpg"
import img8 from "./water/water (8).jpg"
...
const faq = [
  {
      "id": 1 ,
      "question" : "1. What is starting price of a Watercolour Portrait?",
      "answer" : " Watercolor Portraits start from $110. Depending on the size, characters, and other add on the price might change, Please create your order to know the exact price at checkout."
  },
  {
      "id": 2 ,
      "question" : "2. I need the portrait in a custom size, is it possible? What would be the price for it?",
      "answer" : "Yes, we can create a portrait in custom dimensions. Leave the custom dimensions in the Order Notes, and we will paint it in that size. While checking out, select the closest size and checkout"
  },
  {
      "id": 3 ,
      "question" : "3. I have blurred photos; which is the best medium?",
      "answer" : "If you have blurred photos, we recommend you get a Watercolour Portrait because they are not as detailed as any other medium.It is an excellent idea to recover your old blur photos with a Watercolour Portrait so that the memories stay with you for life long."
  },
  {
      "id": 4 ,
      "question" : "4. Will the watercolor painting need any maintenance?",
      "answer" : "No, it won’t. We recommend you get it framed or gallery wrapped for better longevity."
  }
];
    return (
        <div>
        ...
        <Searchbar/>
            <h1 className='font-bold'>Water Color Painting</h1>
        </div>
