...
import data from "./Charcoaldrawing.json"
import img1 from "./charcoal/charcoal (1).jpg"
import img2 from "./charcoal/charcoal (2).jpg"
import img3 from "./charcoal/charcoal (3).jpg"
import img4 from "./charcoal/charcoal (4).jpg"
import img5 from "./charcoal/charcoal (5).jpg"
import img6 from "./charcoal/charcoal (6).jpg"
import img7 from "./charcoal/charcoal (7).jpg"
import img8 from "./charcoal/charcoal (8).jpg"
...
const faq = [
  {
      "id": 1 ,
      "question" : "1. What is the difference between Charcoal and Pencil mediums?",
      "answer" : "Charcoal and Pencil Portraits are both black and white portraits.Charcoal drawings are made with charcoal pencils, and they turn out much darker than a Pencil portrait."
  },
  {
      "id": 2 ,
      "question" : "2. Which pencils do you use and is it drawn on paper?",
      "answer" : "All our Charcoal Drawings are made using premium charcoal pencils from Winsor and Newton on high-quality paper."
  },
  {
      "id": 3 ,
      "question" : "3. How much does it cost to get a Charcoal Drawing?",
      "answer" : "Our Charcoal Drawings start from $60. The prices of all Charcoal Drawings depend upon Size and Characters.Please click on Draw My Portrait to know the price for your Custom Portrait."
  },
  {
      "id": 4 ,
      "question" : "4. What should I prefer among Charcoal and Oil paintings?",
    ...
    return (
        ...
        <Searchbar />
            <h1 className='font-bold'>Charcoal Drawing</h1>
        </div>
